...
const HomeCard = ({ main, desc, icon, link }) => {
	return (
		<Link to={link} className="hover:shadow-2xl hover:-translate-y-1 duration-200 text-white max-w-sm w-60 h-60 bg-gray-500 bg-opacity-40 rounded-lg shadow-md  cursor-pointer flex justify-center items-center">
